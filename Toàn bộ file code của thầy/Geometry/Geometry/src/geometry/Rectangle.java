...
public class Rectangle extends Geometry {
    ...
    public boolean isValid() {
        try {
            double ab = Geometry.length(this.pointA, this.pointB);
            double bc = Geometry.length(this.pointB, this.pointC);
            double cd = Geometry.length(this.pointC, this.pointD);
            double da = Geometry.length(this.pointD, this.pointA);
            if (ab != cd || bc != da || !Geometry.isRightAngle(this.pointA, this.pointB, this.pointC)) {
                return false;
            }
    ...
    public double perimeter() throws GeometryException {
        ...
        return 2 * (Geometry.length(this.pointA, this.pointB)
                + Geometry.length(this.pointB, this.pointC));
    }
    ...
    public double area() throws GeometryException {
        ...
        return Geometry.length(this.pointA, this.pointB) * Geometry.length(this.pointB, this.pointC);
    }
