...
public abstract class PhuongTienGiaoThong {
    ...
    public final void setId(String id) throws PTGTException {
    ...
    public final void setHangSanXuat(String hangSanXuat) throws PTGTException {
        if (hangSanXuat == null) {
            throw new PTGTException("Error: hangSanXuat is null or empty");
        }
    ...
    public final void setNamSanXuat(Year namSanXuat) throws PTGTException {
        if (namSanXuat == null) {
            throw new PTGTException("Error: namSanXuat is null");
        }
        if (namSanXuat.isAfter(Year.now())) {
            throw new PTGTException("Error: " + namSanXuat + " is after now");
        }
    ...
    public final void setGiaBan(double giaBan) throws PTGTException {
        if (giaBan < 0) {
            throw new PTGTException("Error: " + giaBan + " < 0");
        }
        this.giaBan = giaBan;
    }
    ...
    public final void setMauXe(String mauXe) throws PTGTException {
        if (mauXe != null || mauXe.isBlank()) {
            throw new PTGTException("Error: mauXe is null or empty");
        }
        this.mauXe = mauXe;
    }
    ...
    public PhuongTienGiaoThong(
            ...
            Year namSanXuat,
            double giaBan,
            String mauXe) throws PTGTException {
        this.setId(id);
    ...
    public void inputUpdate() throws PTGTException {
        ...
        this.setGiaBan(Util.inputDouble("Nhap gia ban", -100.0));
    ...
    protected abstract boolean validateId(String id) throws PTGTException;
